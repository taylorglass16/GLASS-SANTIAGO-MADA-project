...
plot_3 <- mydata %>% ggplot(aes(x=sarc_standard, y=pct_upreg_sarc)) + 
  ...
  ggtitle("Percent of Unintended Pregnancies vs Standardzied Count of Women Using SARCs") + xlab("Standarized Total Number of Women") + ylab("Percentage of Unintended Pregnancies")
plot(plot_3)
