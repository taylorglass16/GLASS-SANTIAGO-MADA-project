...
# Save data 
Lastly, we will save this data with the new standardized total usage variables for each method of birth control as the second version of our processed data with only the variables necessary for the statistical analysis and modeling portion of the project. This new dataset is saved in the same location as the first processed dataset. 
```{r}
# select variables necessary for statistical analysis/modeling 
processeddata2 <- mydata %>% select(country, wra, region, pct_upreg_larcster, pct_upreg_sarc, pct_upreg_trad,  pct_upreg_nouse, larcster_usage, sarc_usage, trad_usage, none_usage, larcster_standard, sarc_standard, trad_standard, none_standard)

# save it to the same folder with the first version of the processed data
save_data_location <- here("data","processed-data","processeddata2.rds")
