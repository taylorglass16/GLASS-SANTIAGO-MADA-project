...
kable_lmtable1 <- kable(lmtable1)

# save fit results table  
table_file1 = here("results", "tables", "resulttable1.rds")
saveRDS(kable_lmtable1, file = table_file1)
```
...
# create a professional format of the table to add to the manuscript 
kable_lmtable2 <- kable(lmtable2)

# save fit results table  
table_file2 = here("results", "tables", "resulttable2.rds")
saveRDS(kable_lmtable2, file = table_file2)
...
# create a professional format of the table to add to the manuscript 
kable_lmtable8 <- kable(lmtable8)

# save fit results table  
table_file8 = here("results", "tables", "resulttable8.rds")
saveRDS(kable_lmtable8, file = table_file8)
```
...
# create a professional format of the table to add to the manuscript 
kable_lmtable11 <- kable(lmtable11)

# save fit results table  
table_file16 = here("results", "tables", "resulttable16.rds")
saveRDS(kable_lmtable11, file = table_file16)
```
