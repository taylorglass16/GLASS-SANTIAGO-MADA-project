...
Wow, you've done a great job here! I was very easily able to follow all of your wrangling and exploratory methods. You consider many different alternatives and provide all meaningful results in an easy-to-follow manner. I think some of the methods section could be removed from the final manuscript and put in the supplemental file, for example the description of all performance metrics you performed (just state the final one and refer to supplemental for the background analysis you did to get there).
...
Everything was very well documented and easy to follow. However, I think the master Readme could use some clarification. First, it did not mention the `eda.qmd` file and when it should be run. I ran it between the processing and analysis files. Second, I think you could have bullet points (or numbered points) easily showing which code to run in which order. This would make it easier for someone who is not familiar with your project to run it.
