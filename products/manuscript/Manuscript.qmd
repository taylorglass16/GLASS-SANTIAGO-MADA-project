...
colnames(AIUdata)
```
There are 132 observations, one row for each low- to middle- income country, of the 399 variable included in the Adding It Up All Women Dataset. Some examples of measurements included are percentages of pregnancy outcomes, rates of safe and unsafe abortions, percentage of various contraceptive usages, percentages of care received for various pregnancy complications, and costs for many variables including abortions and STIs. 
...
1) What is the relationship between rates of unintended pregnancies and usage of contraceptive methods?
  ...
  -predictor variables:
  number of women 25-34 using modern methods (modmmethods_2534)
  number of women 25-34 using sterilization (ster_2534)
  number of women using long-acting reversible methods (larc_2534)
  ...
  *These variables exist for two other age ranges (20-24 and 35-49), so we could analyze contraceptive usage across age categories too  
  
2) How do the rates of safe abortions fluctuate with available methods for safe abortions?
