...
After deciding on a single outcome variable, we created a summary table with that outcome and the seven predictors we will use to predict it, which can be seen in @tbl-1.
```{r}
#| message: false
#| label: tbl-1
