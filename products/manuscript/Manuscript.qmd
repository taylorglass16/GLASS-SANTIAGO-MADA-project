...
1. Is there a significant difference in the percentage of unplanned pregnancies between three  contraceptive methods among all countries compared to no usage?

2. How does marriage status affect percentage of usage across three different types of birth control per region? (back-up question)
