...
1) What is the relationship between rates of unintended pregnancies and usage of contraceptive methods?
  -outcome variables: 
  unintended pregnancies, total number (pct_upreg) 
  unintended pregnancies, total number [subregional]      (upreg_subreg)
  
  -predictor variables:
  number of women 35-49 using modern methods (modmmethods_3549)
  number of women 35-49 using sterilization (ster_3549)
  number of women 35-49 using long-acting reversible methods (larc_3549)
  number of women 35-49 using short-acting methods (sarc_3549)
  number of women 35-49 using traditional methods (tradmethods_3549)
  number of women 35-49 using no method (nomethod_3549)

We will be looking for patterns in contraceptive methods and higher unintended pregnancies to investigate the effectiveness of each method. We hope to find relationships between subregions, rates of unintended pregnancies, and contraceptive methods to determine possible interventions that will increase the effectiveness of contraceptive methods in each subregion. Each of the predictor variables exist for two other age ranges (20-24 and 25-34), so we could analyze contraceptive usage across age categories within each subregion as well.
