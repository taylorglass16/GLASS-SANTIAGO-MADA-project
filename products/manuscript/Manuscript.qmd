...
After deciding on a single outcome variable, we created a summary table with that outcome and the seven predictors we will use to predict it, which can be seen @table-1.
```{r}
#| message: false
#| label: table-1
